## Go to: https://gemini.google.com/app/97f8351fa48ca467
...
* **Visual Lifecycle Tracking**: Drag-and-drop or click to advance contacts through linear stages:  
  `1. Identified` ➔ `2. Messaged` ➔ `3. Awaiting Reply` ➔ `4. Interview Scheduled` ➔ `5. Follow-up Pending` ➔ `6. Advocate / Nurture`
